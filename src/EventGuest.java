...
public class EventGuest extends OracleConnector
{
   ...
   public static void addEventGuest(int event_id, int guest_id, String dataBaseName, String password){
       try{
        OracleConnector m = new OracleConnector(dataBaseName, password);
            m.connect();
            ...
            m.pst.executeUpdate();
           System.out.println("successfully added to eventGuests");
